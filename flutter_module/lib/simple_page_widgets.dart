...
import 'package:flutter_module/platform_view.dart';
...
class _FirstRouteWidgetState extends State<FirstRouteWidget> {
  ...
  void requestTest() {
    ...
    HttpManager().requestNetwork<List<Todo>>(url: HttpApi.todoCountList, params: {"userId": 3063},).then((value) => {
          
           print('thenthen!--$value')}
           )
        .catchError((onError) {
      print('open natve page!2--$onError');
    });
  }
}
